...
% ------------------------------------------------------------------------------
% to enter a failure, copy/paste this record (below), uncomment, and fill in the
% blanks. escape any strings with https://onlinetexttools.com/escape-text .
% ------------------------------------------------------------------------------
%failure(
%ID,                    % integer
%Failure,               % string 
%_Context,              % string
%Reason,                % unspecified/"fixed on retry"/"kernel too old"/etc
%ReleaseBlocking,       % unspecified/yes/no
%AffectedReleases,      % ["strings", "strings"]
%AffectedUpgradePaths,  % ["strings", "strings"]
%Builds,                % ["strings", "strings"]
%AffectedScenarios      % ["strings", "strings"]
%).
